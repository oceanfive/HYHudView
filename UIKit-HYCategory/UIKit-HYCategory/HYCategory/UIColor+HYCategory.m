...
+ (UIColor *)hy_gradientColorWith:(HYGradientColorDirection)direction colors:(NSArray<UIColor *> *)colors size:(CGSize)size {
    ...
    return [self hy_gradientColorWithStartPoint:startPoint endPoint:endPoint locations:nil colors:colors size:size];
}
...
#pragma mark - 私有方法
+ (UIImage *)hy_gradientColorImageWithStartPoint:(CGPoint)startPoint endPoint:(CGPoint)endPoint locations:(NSArray<NSNumber *> * _Nullable)locations colors:(NSArray <UIColor *>*)colors size:(CGSize)size {
